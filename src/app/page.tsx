...
import SkeletonTemplate from "@/components/landingPage/SkeletonTemplate";
import { UserContextProvider } from "@/context/currUserContext";
  ...
  return (
    <UserContextProvider>
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-gray-900 text-gray-100 flex flex-col overflow-hidden">
        ...
        <Link
          href="/chat"
          className="fixed bottom-4 right-4 w-12 h-12 rounded-full  bg-green-300 flex flex-col items-center justify-center hover:scale-125 z-20"
        >
