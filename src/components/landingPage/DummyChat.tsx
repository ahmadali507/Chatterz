...
import { mockChat } from "@/config/config";
    ...
    <div>
      <main className="flex-grow flex flex-col items-center justify-center p-4 md:p-8 relative">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold text-center pt-44 mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500"
        >
        ...
        >
          Experience seamless communication, real-time collaboration, and
          enhanced productivity with our feature-rich web chat application.
        </motion.p>
        <motion.div
          ...
          >
            ...
            <div className="p-4 bg-gray-700/50 flex space-x-2">
              <Input
                ...
                className="flex-grow bg-gray-600/50 border-purple-500/30"
              />
              <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 active:scale-110">
