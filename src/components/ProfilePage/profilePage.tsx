...
import EditProfilePic from "../ui/EditProfilePic";
...
export default function ProfilePage() {
  ...
  const handleProfilePicEdit = () => {
    setProfilePicEditing(!profilePicEditing);
  }
                ...
                {isEditing ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-center mb-4 w-full h-28 relative">
                      <div className="relative w-28 h-28 rounded-full overflow-none">
                      {/* <Image
                        src={Musa}
                        alt="Profile picture"
                        layout="fill"
                    ...
                    {/* <div className="flex justify-center mb-4 bg-red-300 w-full h-28 ">
                      <Avatar className="w-full h-full">
                        <AvatarImage src={"./jpg"} className="rounded-full" alt="Profile picture" />
